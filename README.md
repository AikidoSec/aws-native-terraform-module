...
| cspm_audit_actions               | IAM actions to allow in the Aikido Security Audit Policy                                                                                                     | `set(string)` | See defaults in `source/variables.tf` | no |
| cspm_role_name                   | Name of the CSPM IAM role                                                                                                                                    | `string`       | `"AikidoSecurityReadonlyRole"` | no       |
| ecr_scan_actions                 | IAM actions to allow in the Aikido Security ECR Scan Policy                                                                                                  | `set(string)` | See defaults in `source/variables.tf` | no |
| ecr_role_name                    | Name of the ECR scanning IAM role                                                                                                                            | `string`       | `"AikidoSecurityEcrScanningRole"` | no       |
| ebs_scan_actions                 | IAM actions to allow in the primary Aikido Security EBS Scan Policy statement                                                                                | `set(string)` | See defaults in `source/variables.tf` | no |
| ebs_snapshot_cleanup_actions     | IAM actions to allow in the conditioned Aikido Security EBS snapshot cleanup statement                                                                       | `set(string)` | See defaults in `source/variables.tf` | no |
